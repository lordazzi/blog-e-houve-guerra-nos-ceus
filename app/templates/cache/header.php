...
<body>
  ...
  <nav
    ...
    class="sidebar-menu"
  >
    <?php $counter1=-1; if( isset($this->var['books']) and is_array($this->var['books']) and sizeof($this->var['books']) ) foreach( $this->var['books'] as $key1 => $value1 ){ $counter1++; ?>
    ...
    <ul>
      <?php $counter2=-1; if( isset($value1->chapters) and is_array($value1->chapters) and sizeof($value1->chapters) ) foreach( $value1->chapters as $key2 => $value2 ){ $counter2++; ?>
